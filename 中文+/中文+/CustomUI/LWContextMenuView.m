...
@interface LWContextMenuView ()<UIGestureRecognizerDelegate>
...
@implementation LWContextMenuView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [btn setBackgroundImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"ceterZS" ofType:@"png"]] forState:UIControlStateNormal];
